		...
		<nav class="nav navbar-nav">
			<ul class=" navbar-right">
				<li class="nav-item dropdown open" style="padding-left: 15px;">
					...
					aria-expanded="false"> <img src="${pageContext.request.contextPath}/resources/images/theme/뽀짝.jpg" alt="">뽀짝
				</a>
				...
				<li role="presentation" class="nav-item dropdown open"><a
					...
					<ul class="dropdown-menu list-unstyled msg_list" role="menu"
						...
						<li class="nav-item"><a class="dropdown-item"> <span
								class="image"><img src="${pageContext.request.contextPath}/resources/images/theme/뽀짝.jpg"
