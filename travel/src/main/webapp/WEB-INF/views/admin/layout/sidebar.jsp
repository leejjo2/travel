		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			<div class="menu_section active">
				...
				<ul class="nav side-menu" style="">
					<li class="active"><a><i class="fa fa-home"></i> 대쉬보드 </a></li>
					<li><a><i class="fa fa-edit"></i> 회원정보관리 <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a
								href="${pageContext.request.contextPath}/admin/memberManage/list">일반회원관리</a></li>
							<li><a href="${pageContext.request.contextPath}/admin/memberManage/partnerList">판매자회원관리</a></li>
							<li><a href="form_validation.html">관리자회원관리</a></li>
					...
					<li><a><i class="fa fa-clone"></i>매출현황 관리 <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="fixed_sidebar.html">Fixed Sidebar</a></li>
							<li><a href="fixed_footer.html">Fixed Footer</a></li>
						</ul></li>
					<li><a><i class="fa fa-clone"></i>숙박업체 관리 <span
							class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="fixed_sidebar.html">Fixed Sidebar</a></li>
							<li><a href="fixed_footer.html">Fixed Footer</a></li>
