...
<script type="text/javascript">
	...
	function searchList() {
		...
		f.action = "${pageContext.request.contextPath}/admin/memberManage/partnerList";
		f.submit();
	}
	...
	function detailedMember(userId) {
		...
		let url = "${pageContext.request.contextPath}/admin/memberManage/partnerDetaile";
	...
	function updateOk() {
		...
		if (!f.partnerStatus.value) {
			f.partnerStatus.focus();
			return;
		}

		let url = "${pageContext.request.contextPath}/admin/memberManage/updatePartnerState";
...
<div class="right_col" role="main" style="min-height: 4645px;">
	<div class="body-container">
		<div class="body-title">
			<h2>
				<i class="icofont-users"></i> 판매자 관리
			</h2>
		</div>
