...
<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/activity/css/activityReserve.css">
...
function checkPoint() {
	...
	if(usingPoint > ${mdto.totalMileage}){
...
function payment(){
	let name = $('input[name=activityName]').val();
...
<div id="Mrt3Payment-react-component-af4ab29c-68dc-4758-85df-2bfa96d167d6">
	<main class="css-iiwtf3--Order-style--container">
		<form name="reserveForm" class="css-rl7jky--Order-style--formWrapper" data-gtm-form-interact-id="0" method="post">
			...
			<input type="hidden" name="totalMen" value="${totalMen}">
			<input type="hidden" name="totalPrice" value="">
			<input type="hidden" name="detailNum" value="${rdto.detailNum}">
						...
						<div class="css-6oivj6--SectionContainer-style--body">
							<div class="css-1ngshdk--ProductInfo-style--container">
								<div class="css-131e4uu--ProductInfoSummary-style--titleWrapper">
									<div class="css-13kuit9--ProductInfoSummary-style--imageWrapper">
										<img src="${pageContext.request.contextPath}/uploads/activity/${rdto.titleImgname}"
											alt="상품 이미지" class="css-1pgwovl--ProductInfoSummary-style--image">
									</div>
									<div class="css-1m4b4kf--ProductInfoSummary-style--textWrapper">
										<h3 class="css-b9w54p--ProductInfoSummary-style--title">${rdto.activityName}</h3>
										<div class="css-1igu7h--ProductInfoSummary-style--schedule">
											<time>2022년 07월 15일 (금)까지</time>
											<span></span>
										</div>
									</div>
								</div>
								<ul class="css-dhq5u9--ProductInfoOptions-style--optionWrapper">
									<li class="css-jenar4--ProductInfoOptions-style--option">
										<div class="css-zsirvp--ProductInfoOptions-style--optionText">
											<span class="css-1owvnko--ProductInfoOptions-style--optionName">[대소공통] 이용권</span>
										</div>
										<div class="css-1jsv9db--ProductInfoOptions-style--optionPrice"> ${totalMen} x <span class="ticketPrice"></span></div>
									</li>
								</ul>
								<div class="css-k8xwt8--ProductInfoPrice-style--totalPriceWrapper">
									<div class="css-hzi8i2--ProductInfoPrice-style--totalPriceText">총 상품 금액</div>
									<strong class="css-d2hlqw--ProductInfoPrice-style--totalPriceNumber"><span class="totalPrice"></span>원</strong>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="css-wnkz6f--ReservationPersonInfo-style--wrapper">
									<div class="css-8dvoxp--ReservationPersonInfo-style--summary">
										<div class="css-17w6aox--InfoField-style--field">
											...
											<div class="css-1ng6plb--InfoField-style--content">${mdto.name}</div>
										</div>
										<div class="css-17w6aox--InfoField-style--field">
											<div class="css-17ni6ie--InfoField-style--title">이메일 주소</div>
											<div class="css-1ng6plb--InfoField-style--content">${mdto.email}</div>
										</div>
										<div class="css-17w6aox--InfoField-style--field">
											<div class="css-17ni6ie--InfoField-style--title">휴대전화 번호</div>
											<div class="css-1ng6plb--InfoField-style--content">+82 ${mdto.tel}</div>
										</div>
									</div>
							...
							<div class="css-dj0jqn--AdditionalInfoForm-style--container">
								<div class="css-1sa04ji--ExtraReservationInfoContainer-style--container">
									...
									<div class="css-p2k6j6">
										<input name="name" type="text" placeholder="답변을 작성해 주세요." maxlength="100" class="css-hbvhc7" value=""
