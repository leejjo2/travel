		...
		<div class="body-main">
			...
			<form name="hotelForm" method="post">
				<table class="table mt-5 write-form">
					<tr>
						<td class="table-light col-sm-2" scope="row">숙소이름</td>
						<td colspan="3">
					...
					<tr>
						<td class="table-light col-sm-2" scope="row">호수</td>
						<td class="col-sm-4">
					...
					<tr>
						<td class="table-light col-sm-2" scope="row">숙박인원</td>
						<td>
							<div class="row">
						...
						<td class="table-light col-sm-2" scope="row">침대</td>
						<td>
							<div class="row">
					...
					<tr>
						<td class="table-light col-sm-2" scope="row">판매자 명</td>
 						<td colspan="3">
					...
					<tr>
						<td class="table-light col-sm-2" scope="row">옵션</td>
						<td colspan="3">
							<div class="row">
