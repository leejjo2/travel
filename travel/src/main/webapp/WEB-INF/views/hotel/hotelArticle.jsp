                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-outline-info btn-lg" name="submit" value="buy">예약하기</button>
                                    </div>
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-outline-info btn-lg" name="submit" value="addtocard">찜하기</button>
                                    </div>
                                </div>
                            </form>
                        </div>
