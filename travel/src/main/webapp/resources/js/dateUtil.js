...
function daysLater(sDate, days) {
    ...
    y = parseInt(sDate.substring(0, 4));
    m = parseInt(sDate.substring(4, 6));
    // d = parseInt(sDate.substring(6))+parseInt(days);
    d = parseInt(sDate.substring(6))+parseInt(days)-1;
...
function diffDays(sDate, eDate) {
    ...
    let sy = parseInt(sDate.substring(0, 4));
    let sm = parseInt(sDate.substring(4, 6));
    let sd = parseInt(sDate.substring(6));
    
    let ey = parseInt(eDate.substring(0, 4));
    let em = parseInt(eDate.substring(4, 6));
    let ed = parseInt(eDate.substring(6));
